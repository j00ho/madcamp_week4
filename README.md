...
저희는 **“음악에 둘러싸인 공간”**이라는 키워드에 착안하여 공간을 큐브로 표현하였습니다.
...
<aside>
👆 **키보드 방향키**를 눌러 다른 페이지(장르)로 넘어갈 수 있습니다.
...
<aside>
👆 마우스 커서를 화살표에 **호버링**하면 어느 페이지로 이동 가능한지 알 수 있습니다.

- 구현
    
    현재 바라보는 면에 따라 상하좌우 면에 어떤 장르의 면이 있는 지를 저장
